...
void init (void)
{
	//glClearColor (1.0, 1.0, 1.0, 0.0); // fundalul
      ...
      case GLUT_LEFT_BUTTON:
         if (state == GLUT_DOWN)
            //xx0 = 13.0, yy0 = 11.0, zz0 = 14.0;
			 xx0 = -2.0, yy0 = -4.0, zz0 = -1.0; // am luat un n2=(5,5,5)  si am schimbat
												// la click stanga poligonul se vede din spate
		 glClearColor(0.5, 0.5, 1.0, 0.0); // fundalul
		 init ( );								 
		 //desen2 ( );
		 break;
      case GLUT_RIGHT_BUTTON:
         if (state == GLUT_DOWN)
            //xx0 = -7.0, yy0 = -9.0, zz0 = -6.0;			
		     xx0 = 8.0, yy0 = 6.0, zz0 = 9.0;     // iar la click dreapta poligonul se vede din fata    
		 glClearColor(0.75, 1.0, 1.0, 0.0); // fundalul
		 init ( );
		// desen2 ( );
		 break;
